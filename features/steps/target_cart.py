...
def click_side_navigation_add_to_cart(context):
    ...
    context.app.side_navigation_search_result_page.click_side_navigation_add_to_cart()
...
def store_product_name(context):
    ...
    context.product_name = context.app.side_navigation_search_result_page.get_product_name()
...
def click_on_view_cart_and_checkout(context):
    ...
    context.app.side_navigation_search_result_page.click_view_cart_and_checkout()
...
def verify_search_result(context):
    ...
    context.app.search_results_page.verify_search_results_correct(search_word)
...
def verify_item_added_to_cart(context):
    ...
    context.app.cart_summary_page.verify_item_added_to_cart()


@then("Verify cart has product name")
def verify_product_name(context):
    # actual_product_name = context.driver.find_element(*CART_PRODUCT_NAME).text
    # assert context.product_name == actual_product_name, \
    #     f"Expected '{context.product_name}' but got '{actual_product_name}'"
    context.app.cart_summary_page.verify_product_name(context.product_name)
